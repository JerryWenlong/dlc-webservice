(function() {
    'use strict'
    DLC.PayBindCardAuthed = DLC.derive(null, {
        ...
        initPage: function() {
            ...
            $('#holderName').text(app.account.accountInfo.name);
            this.initBindCard();
        ...
        checkList: function() {
            ...
            var r3 = this.checkPhoneNo;
            var r4 = this.checkOtpCode;
        ...
        bindCard: function() {
            ...
            this.account.bindAccountCard(data, function(responseData) {
                window.location.href = "//" + that.orderNo;
            }, function(errorCode, errorMsg) {
